...
colnames(changed_manifests_df)
# jsonlite::write_json(changed_manifests_df, "https://raw.githubusercontent.com/adknowledgeportal/data-models/refs/heads/main/changed-manifests.json", pretty = TRUE, auto_unbox = TRUE)
```
